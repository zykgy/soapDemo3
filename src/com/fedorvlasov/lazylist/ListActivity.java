...
import com.example.soapdemo3.Category;
import com.example.soapdemo3.R;
import com.example.soapdemo3.WebToolKit;
...
public class ListActivity extends Activity {
    ...
    private ArrayList<String> categoriesPicterusURL;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Intent i = getIntent();
        Bundle bundle =i.getBundleExtra("categorie");
        categories =bundle.getParcelableArrayList("Categorys");
        
        categoriesPicterusURL =new ArrayList<String>();
		categoriesPicterusName =new ArrayList<String>();
		
        for (Category category : categories) {
        	if(category.getParentcat()==0){
        		categoriesPicterusName.add(category.getName());
				categoriesPicterusURL.add(WebToolKit.CategoriesPicterusURL+category.getImage());
			}
		}
        
        list=(ListView)findViewById(R.id.list);
        adapter=new LazyAdapter(this,categoriesPicterusURL,categoriesPicterusName);
